...
const UpdateProfileForm = ({profile, handleSubmit, toggleModal, auth}) => {
            ...
            {({ handleChange, values, handleSubmit, setFieldTouched, touched, errors}) => (
                <>
                    ...
                    <View style={styles.modalActions}>
                        ...
                        <PrimaryButton loading={auth.updateProfileRequest} disabled={auth.updateProfileRequest} style={styles.button} title="Save" onPress={() => {handleSubmit()}} />
                    </View>
                </>
            )}
        </Formik>
